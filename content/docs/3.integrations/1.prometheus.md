# Prometheus Connector Instructions

The Prometheus Connector enables seamless integration with Prometheus, allowing Castrel to query and analyze prometheus's metrics, rules and alerts.
