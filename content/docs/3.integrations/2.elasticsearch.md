# Elasticsearch Connector Instructions

The Elasticsearch Connector enables seamless integration with Elasticsearch (and compatible OpenSearch), allowing Castrel to query and analyze Elasticsearch's indices, mappings and documents.
