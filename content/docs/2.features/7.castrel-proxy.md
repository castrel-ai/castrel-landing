...
Go to Castrel website (e.g. [https://app.castrel.ai/](https://app.castrel.ai/)) and create an account or login.
![Castrel Login](/images/castrel-login.png)

**2. Get pairing command**

Navigate to the **New Task** page, then on the right side of the chat interface, click the **Castrel Proxy icon** and click **New Connection** to generate a pairing command.
![Castrel Proxy Button](/images/castrel-proxy-button.png)

**3. Run the pairing command**

Copy the pairing command from the website and run it on your server where `castrel-proxy` is installed:

![Pairing Command](/images/castrel-proxy-pair-code.png)
