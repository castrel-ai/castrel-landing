...
Supports `@elasticsearch` in conversations to quickly search index names via a three-column drill-down (cluster → index → operation).

## Useful Links

- [Elasticsearch Query DSL](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html)
- [EQL Event Query Language](https://www.elastic.co/guide/en/elasticsearch/reference/current/eql.html)
- [X-Pack API Key Management](https://www.elastic.co/guide/en/elasticsearch/reference/current/security-api-create-api-key.html)
