...
category: Product
image:
    src: /images/blog/3.slo-dashboard-health-checks/header-en.png
seo:
    ogImage: /images/blog/3.slo-dashboard-health-checks/header-en.png
navigation: false
---
...
![A user starts the SLO workflow with a /slo request](/images/blog/3.slo-dashboard-health-checks/1-slo-en-v2.mp4)

*Stage 1: the user starts with `/slo`, and Castrel begins reading application context, inspection SOPs, and observability data.*
...
![The agent generates a dashboard with SLO rules and observability panels](/images/blog/3.slo-dashboard-health-checks/2-生成dashboard-en.mp4)

*Stage 2: Castrel turns the business journey, historical baseline, and Prometheus queries into a dashboard with SLO rules.*
...
![The completed SLO dashboard with objectives, thresholds, and supporting charts](/images/blog/3.slo-dashboard-health-checks/3-dashboard-en.mp4)

*Stage 3: once generated, the dashboard gives the team a complete view of service objectives, thresholds, trends, and supporting signals.*
...
![A health check reads and uses the archived SLO dashboard](/images/blog/3.slo-dashboard-health-checks/4-使用dashboard-en.mp4)

*Stage 4: a later health check reads the archived SLO dashboard and combines rule evaluation with cross-signal analysis.*
